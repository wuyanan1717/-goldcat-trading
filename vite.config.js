...
const disablePwa = process.env.DISABLE_PWA === 'true' || process.env.VERCEL === '1'
  ...
  plugins: [
    ...
    !disablePwa && VitePWA({
      ...
      manifest: {
        ...
        short_name: 'GoldCat',
        description: 'Elite Quantitative Trading Terminal',
        theme_color: '#000000',
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            // Cache JS and CSS files (StaleWhileRevalidate for instant load + background update)
            urlPattern: /\.(?:js|css)$/i,
            handler: 'StaleWhileRevalidate',
            options: {
