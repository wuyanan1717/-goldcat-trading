                        ...
                        {/* --- 3. AI 行为诊断 (核心卖点) --- */}
                        {
                            activeTab === 'ai_analysis' && (
                                <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in">
                                    {/* 会员锁定遮罩 */}
                                    {!membership.isPremium && (
                                        <div className="w-full lg:col-span-3 bg-gradient-to-r from-neutral-900 to-neutral-800 rounded-2xl p-6 border border-amber-500/30 relative overflow-hidden flex flex-col items-center text-center">
                                            ...
                                            <p className="text-gray-400 mb-8 text-lg relative z-10 max-w-2xl mx-auto">
                                                {t('ai.locked_desc')}
                                            </p>
