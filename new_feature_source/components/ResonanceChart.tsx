...
export const ResonanceChart: React.FC<ResonanceChartProps> = ({ 
  title, 
  meta, 
  data, 
  color, 
    ...
    <div className="chart-wrapper group relative">
      <div className="flex justify-between items-center mb-2 px-1">
        ...
        <div className="flex items-center gap-3">
            ...
            {latest && (
                <div className={`flex items-center gap-1 text-[9px] font-mono border px-1 rounded ${
                    isOverbought ? 'border-red-500/50 text-red-400' : 
        ...
        {data.length > 0 && (
          <div className="absolute top-2 right-2 flex items-center gap-1">
            <div className={`w-1.5 h-1.5 rounded-full animate-pulse shadow-[0_0_5px] ${
                isOverbought ? 'bg-red-500 shadow-red-500' : 
